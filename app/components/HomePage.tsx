        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Discover high-performance PC parts at unbeatable prices. From flagship GPUs to ultra-fast storage, we have everything you need to build your dream rig.
            </p>
            <Link
              to="/search"
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center gap-2 mb-3 mt-auto">
                    ...
                    <span className="text-sm text-muted-foreground">({product.reviews || Math.floor(Math.random() * 50) + 10})</span>
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-r from-primary to-primary/80 rounded-lg p-12 text-center text-primary-foreground relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="mb-4 text-primary-foreground text-3xl font-bold">Build Your Dream PC Today</h2>
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Get an extra 5% off your first build with code: <span className="font-mono font-bold bg-white/20 px-2 py-1 rounded">BUILD5</span>
            </p>
            <Link
              to="/search"
