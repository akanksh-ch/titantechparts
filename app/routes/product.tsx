        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              {product.description ||
                `Experience superior performance with the ${product.name}. Built for enthusiasts and professionals alike, this component delivers exceptional reliability and speed for your most demanding tasks.`}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <button
                ...
                className={`flex items-center justify-center px-6 py-4 rounded-lg border-2 transition-colors ${
              ...
              >
                <Heart
                  className={`w-6 h-6 ${isInWishlist(product._id || product.id) ? "fill-current" : ""}`}
                />
              </button>
            </div>
          ...
          {product.reviews && product.reviews.length > 0 ? (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="font-medium block">
                          {review.reviewer || review.user || "Anonymous User"}
                        </span>
            ...
            <div className="bg-muted/30 border border-dashed border-border rounded-xl p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                Be the first to share your thoughts on this product with the
                community.
              </p>
